...
public class DetailAndHistoryActivity extends SherlockFragmentActivity implements OnMenuItemSelectedListener, OnDetailPass, OnCoordinatePass, ActionBar.OnNavigationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.history_and_detail);
		setCurrentView(PreferenceValue.VIEW_DETAIL_AND_HISTORY);
		detailFragment = (HistoryDetailFragment)getSupportFragmentManager().findFragmentById(R.id.detail_history_detail_fragment);
	...
	private void doMenu() {
		if (mMenu.isShowing()) {
			...
			mMenu.show(findViewById(R.id.detail_history_detail_fragment));
			actionBar.show();
		}
	}
