...
public class BasicEvent {
	...
	/**
	 * Create a new Basic Event object 
	 * @param id
	 * @param title
	 * @param latitude
	 * @param longitude
	 ...
	 */
	public BasicEvent(int id, String title, double latitude,
	 ...
	 * @param shortDescription
	 */
	public BasicEvent(String id, String title, String latitude,
	...
	public String toString() {
		return "BasicEvent [id=" + id + ", title=" + title + ", latitude="
	 ...
	 */
	public String getBasicEventString() {
