...
public class BasicFavorite {
	...
	/**
	 * Create an empty Basic Favorite object
	 */
	public BasicFavorite() {
	}

	/**
	 * Create a new Basic Favorite object 
	 * @param id
	 * @param title
	 * @param latitude
	 * @param longitude
	 ...
	 */
	public BasicFavorite(int id, String title, double latitude,
	 ...
	 * @param shortDescription
	 */
	public BasicFavorite(String id, String title, String latitude,
	...
	public String toString() {
		return "BasicFavorite [id=" + id + ", title=" + title + ", latitude="
				+ latitude + ", longitude=" + longitude + ", imageUrl="
				+ imageUrl + ", shortDescription=" + shortDescription + "]";
	}
	
	/**
	 * Get basic concatenated string of Basic Favorite
	 * @return parsable Basic Favorite String
	 */
	public String getBasicFavoriteString() {
