...
public class FavoriteDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.favorite_detail, container, false);
		initViewComponents();
		return view;
	}
	...
	private void initViewComponents() {
		title = (TextView)view.findViewById(R.id.favorite_detail_title);
		startTime = (TextView)view.findViewById(R.id.favorite_detail_start_time);
		endTime = (TextView)view.findViewById(R.id.favorite_detail_end_time);
		img = (ImageView) view.findViewById(R.id.favorite_detail_image);
	}

	/**
	 * display detail information of the favorite. Call from the activity container
	 * @param dealId
	 * @param mtitle
	 * @param mImgSrc
	 */
	public void dislayFavoriteDetail(int mdealId, String mtitle, String mImgSrc) {
		id = mdealId;
		if (id != -1) {
			...
			title.setText(Global.NO_FAVORITE);
		...
		new AsyncTask<Void, Void, String>() {		
			...
			protected String doInBackground(Void... params) {
				try {
					...
					postParameters.add(new BasicNameValuePair("timeRequestId", String.valueOf(id)));
