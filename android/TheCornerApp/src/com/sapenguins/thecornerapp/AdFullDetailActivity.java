...
public class AdFullDetailActivity extends FragmentActivity implements OnGlobalLayoutListener{
	 ...
	 */
	private void setFavoriteButtonOnClickListener() {
	...
	/**
	 * Set the click listener for like button
	 */
	private void setLikeButtonOnClickListener() {
				...
				new AsyncTask<Void, Void, Void>() {		
					...
					protected Void doInBackground(Void... params) {
						try {
							...
							postParameters.add(new BasicNameValuePair("like", String.valueOf(adId)));
	...
	private void initViewComponents() {
		...
		favoriteButton = (Button) findViewById(R.id.ad_full_star_button);
		setFavoriteButtonOnClickListener();
		likeButton = (Button) findViewById(R.id.ad_full_like_button);
		setLikeButtonOnClickListener();
		
		
		//add to favorite
		addToFavorite= (TextView) findViewById(R.id.ad_full_detail_add_to_favorite);
		addToFavorite.setOnClickListener(new TextView.OnClickListener() {
			@Override
			public void onClick(View v) {
				AlertDialog.Builder builder = new AlertDialog.Builder(context);
			    builder.setTitle("Would you like to add this ad to your favorites?")
	...
	private void setClosingMapButtonClickListener() {
		closingMapButton.setOnClickListener(new ImageView.OnClickListener() {
			@Override
			public void onClick(View v) {
				supportMapContainer.setVisibility(View.GONE);
