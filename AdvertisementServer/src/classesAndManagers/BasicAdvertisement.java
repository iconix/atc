...
public class BasicAdvertisement {
	...
	/**
	 * Create an empty Basic Advertisement object
	 */
	public BasicAdvertisement() {
	}

	/**
	 * Create a new Basic Advertisement object 
	 * @param id
	 * @param title
	 * @param latitude
	 * @param longitude
	 ...
	 */
	public BasicAdvertisement(int id, String title, double latitude,
	...
	public String toString() {
		return "BasicAdvertisement [id=" + id + ", title=" + title + ", latitude="
